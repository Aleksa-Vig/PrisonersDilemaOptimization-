...
class SimulatedAnnealing:
    ...
    def _accept_neighbor(self, neighbor):
        """
        Probabilistically determines whether to accept a transition to a neighbor
        :param neighbor: a state
        :return: boolean indicating whether transition is accepted
        """
        try:
...
if __name__ == '__main__':
    sa = SimulatedAnnealing(initial_state=random_bot(), max_steps=100, schedule_constant=0.1, temp_begin=10)
    sa.run()
